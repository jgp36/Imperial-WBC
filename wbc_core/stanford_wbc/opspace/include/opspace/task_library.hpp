...
class TestImplicitSurfaceTask
  : public Task 
{
public:
  explicit TestImplicitSurfaceTask(std::string const & name);
...
class TestKnownImplicitSurfaceTask
  : public Task 
{
public:
  explicit TestKnownImplicitSurfaceTask(std::string const & name);
  virtual Status init(Model const & model);
  virtual Status update(Model const & model);
  virtual void dbg(std::ostream & os,
		   std::string const & title,
...
{
public:
  explicit TestVelOriSurfaceTask(std::string const & name);
  virtual Status init(Model const & model);
  virtual Status update(Model const & model);
  virtual void dbg(std::ostream & os,
		   std::string const & title,
...
class TestMassOptTask
  : public Task 
	{
	public:
  explicit TestMassOptTask(std::string const & name);
